...
int main() {
    ...
    HANDLE htimer = CreateWaitableTimerW(NULL, FALSE, L"OS08_04");
...

    {
        ...
        CreateProcessW(an, NULL, NULL, NULL, FALSE, CREATE_NEW_CONSOLE, NULL, NULL, &si, &pi1) ?
            cout << "Process OS08_04xA created \n" : cout << "Process OS08_04xA not created \n";
    }
    {
        STARTUPINFO si; ZeroMemory(&si, sizeof(STARTUPINFO)); si.cb = sizeof(STARTUPINFO);
        CreateProcessW(an, NULL, NULL, NULL, FALSE, CREATE_NEW_CONSOLE, NULL, NULL, &si, &pi2) ?
