...
int main()
{
    ...
    insRowFileTxt(fileName, (LPWSTR)L"1.Андреев Евгений Владимирович(0)", 0);
    insRowFileTxt(fileName, (LPWSTR)L"4.Демидов Виктор Владимирович(-1)", -1);
    insRowFileTxt(fileName, (LPWSTR)L"TESTSTRING(4)", 4);
    insRowFileTxt(fileName, (LPWSTR)L"10.Копыл Ефим Игоревич(7)", 7);
